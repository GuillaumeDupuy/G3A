...
<?php $__env->startSection('contenu'); ?>
    ...
    <?php if($user->admin): ?>
        ...
        <p>Les revenus du site totaux : <?php echo e($revenu_totaux); ?></p>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <?php endif; ?></td>
                                        <td class="text-right">
                                        <form action="<?php echo e('/user/'.$u->id); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jerem\Documents\CoursYnov\2020_2021\Projet web\projet_dev_web_b2\G3A\resources\views/profil.blade.php ENDPATH**/ ?>