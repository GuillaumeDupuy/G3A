  ...
  <div class="col-lg-9">
    <?php if(!empty($produit)): ?>
      <div class="card mt-4 card-flex">
        <img class="card-img-top img-fluid" src="<?php echo "images/".$produit->photo;?>" alt="">
        <div class="card-body">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ynov\B2\Projet B2\Projet Dev Web\projet_dev_web_b2\G3A\resources\views/produit.blade.php ENDPATH**/ ?>